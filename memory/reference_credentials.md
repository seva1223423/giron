...
- Путь: `C:/Users/sevka/Desktop/1223/work/iron-gym/server/.env` (рабочий клон проекта — каталог остался `iron-gym`, хотя GitHub repo переименован в `giron`)
- Старого пути `C:/Users/sevka/Projects/iron-gym/` больше нет — проект переехал в `Desktop/1223/work/iron-gym/`
...
|---|---|---|
| Render | Хостинг API, slug `giron-api`, URL `https://iron-gym-swoe.onrender.com`, Frankfurt free | Автодеплой на `git push` в master. Для API управления нужен Render key — в `.env` нет, создавать в dashboard → Account Settings → API Keys |
