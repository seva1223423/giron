...
```bash
cd C:/Users/sevka/Desktop/1223/work/giron && npx tsc --noEmit 2>&1 | tail -5
cd C:/Users/sevka/Desktop/1223/work/giron/server && npx tsc --noEmit 2>&1 | tail -5
```

**BLOCKER** if any errors. Also flag `console.log` in server routes:
```bash
grep -rn "console\." C:/Users/sevka/Desktop/1223/work/giron/server/src/routes/ --include="*.ts" | grep -v "^\s*//"
```

## 2 — Tests

```bash
cd C:/Users/sevka/Desktop/1223/work/giron/server && npm test -- --forceExit 2>&1 | tail -5
# Expected: 38 suites, ~1412 tests

cd C:/Users/sevka/Desktop/1223/work/giron && npm test -- --forceExit 2>&1 | tail -5
...
# Expected: 38
cd C:/Users/sevka/Desktop/1223/work/giron && git log --oneline -3 server/prisma/schema.prisma
```
...
grep -n "router\.\(get\|post\|put\|delete\|patch\)" C:/Users/sevka/Desktop/1223/work/giron/server/src/routes/workout.ts | grep -v "authenticate"

# CORS wildcard check
grep -n "origin.*\*" C:/Users/sevka/Desktop/1223/work/giron/server/src/index.ts

# AI per-user rate limit still in place (30 req/min, .unref() prune)
grep -n "perUserAiBuckets\|\.unref()" C:/Users/sevka/Desktop/1223/work/giron/server/src/routes/ai.ts | head -5

# AI analytics context timing guard (warn if > 2000ms)
grep -n "_t0Context\|> 2000" C:/Users/sevka/Desktop/1223/work/giron/server/src/routes/ai.ts | head -4
```
...
```bash
grep -n "health\|SELECT 1\|\$queryRaw\|dbLatencyMs" C:/Users/sevka/Desktop/1223/work/giron/server/src/index.ts | head -8
```
...
```bash
grep "import.*Screen" C:/Users/sevka/Desktop/1223/work/giron/src/navigation/AppNavigator.tsx | wc -l
grep "Screen name=" C:/Users/sevka/Desktop/1223/work/giron/src/navigation/AppNavigator.tsx | wc -l
```
...
```bash
grep -rhn "process\.env\." C:/Users/sevka/Desktop/1223/work/giron/server/src/ --include="*.ts" | grep -oP "process\.env\.\w+" | sort -u
```
...
```bash
cd C:/Users/sevka/Desktop/1223/work/giron && git status --short && git log --oneline origin/master..HEAD
```
...
```bash
grep -n "суитов\|suites\|тестов\|tests" C:/Users/sevka/Desktop/1223/work/giron/CLAUDE.md | head -4
