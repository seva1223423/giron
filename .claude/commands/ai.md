...
```bash
grep -n "data_logging\|program_creation\|workout_modify\|technique_question\|nutrition_query\|analytics_query\|greeting\|complaint\|motivation\|general" C:/Users/sevka/Desktop/1223/work/giron/server/src/routes/ai.ts | grep -v "^\s*//" | wc -l
```
...
```bash
grep -c "type: 'function'" C:/Users/sevka/Desktop/1223/work/giron/server/src/routes/ai.ts
```
...
```bash
grep -n "perUserAiBuckets\|PER_USER_AI_LIMIT\|PER_USER_AI_WINDOW\|\.unref()" C:/Users/sevka/Desktop/1223/work/giron/server/src/routes/ai.ts | head -10
```
...
```bash
grep -n "BUG-AI-003\|perUser" C:/Users/sevka/Desktop/1223/work/giron/server/src/__tests__/ai_security.test.ts
```
...
```bash
grep -n "_t0ContextPrimary\|_t0ContextSecondary\|> 2000\|primaryContextMs\|secondaryContextMs" C:/Users/sevka/Desktop/1223/work/giron/server/src/routes/ai.ts | head -8
```
...
```bash
grep -n "daily\|10\|ChatMessage.*count\|quota\|free.*tier\|FoodScanLog" C:/Users/sevka/Desktop/1223/work/giron/server/src/routes/ai.ts C:/Users/sevka/Desktop/1223/work/giron/server/src/routes/nutrition.ts | grep -v "^\s*//" | head -15
```
...
```bash
grep -n "TTL\|max.*200\|14400\|4.*hour" C:/Users/sevka/Desktop/1223/work/giron/server/src/routes/ai.ts | head -5
grep -in "не является\|не медицин\|disclaimer" C:/Users/sevka/Desktop/1223/work/giron/server/src/routes/ai.ts C:/Users/sevka/Desktop/1223/work/giron/server/src/knowledge/ -r | head -5
```
...
```bash
grep -n "mistral\|deepseek\|ollama\|fallback\|catch\|retry" C:/Users/sevka/Desktop/1223/work/giron/server/src/services/deepseekAI.ts | head -15
```
