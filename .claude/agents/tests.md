...
src/__tests__/                  — client store unit tests (Jest, 27 suites, 489 tests)
...
**Expected baseline:** 410 server tests pass (19 suites), 489 client tests pass (27 suites).
...
- **Test count reference** — as of 2026-04-22: 410 server tests (19 suites), 489 client tests (27 suites). Before adding a new test suite, confirm the file doesn't already exist in the relevant `__tests__/` directory.
