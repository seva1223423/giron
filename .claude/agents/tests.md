...
```
server/src/__tests__/           — server integration tests (Jest + Supertest, 17 suites, 364 tests)
...
**Expected baseline:** 364 server tests pass (17 suites), 448 client tests pass (25 suites).
...
- **Test count reference** — as of 2026-04-22: 364 server tests (17 suites), 448 client tests (25 suites). Before adding a new test suite, confirm the file doesn't already exist in the relevant `__tests__/` directory.
