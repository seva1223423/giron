...
```
server/src/__tests__/           — server integration tests (Jest + Supertest, 15 suites, 324 tests)
...
**Expected baseline:** 324 server tests pass (15 suites), 448 client tests pass (25 suites).
...
- **Test count reference** — as of 2026-04-22: 324 server tests (15 suites), 448 client tests (25 suites). Before adding a new test suite, confirm the file doesn't already exist in the relevant `__tests__/` directory.
