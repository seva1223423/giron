...
/**
 * Top banner that surfaces network state to the user.
 *
 ...
 *      a request fails with a network error. After the round-288 timeout
 ...
 *      cold-start.
 *
 * Both states are reactive — the bar appears/disappears as the store
 * mutates. No imperative API.
 */
