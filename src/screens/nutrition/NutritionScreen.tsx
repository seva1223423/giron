...
import {
  GoalsModal, QuickAddModal, DailyOverview, WaterTracker,
  SavedFoodsQuickAdd, MealSection, DateNavigator, MEAL_TYPES, QuickMeals,
  NutritionHeader, NutritionHeroButton, NutritionTabBar, NutritionTab,
  NutritionMenu, WeekTab,
} from './components';
...
export const NutritionScreen: React.FC<{ navigation: any }> = ({ navigation }) => {
  ...
  // TODO: dedicated food search screen — currently routes to Recipes as a placeholder.
