 ...
 *
 * Mirrors WorkoutsHeader structure: title + 🔍 + ⋮.
 * The 4-pill nav row and "Цели" button were retired; their actions
 * moved into the inline NutritionMenu (⋮).
 */
