...
/**
 * Dedicated exercise search screen — round 290.
 *
 * Reachable from the 🔍 button in WorkoutsHeader. Logic mirrors the
 * old ExercisesTab: search input + muscle/equipment filters + favorites
 * toggle + server fetch with fallback to the local 71-exercise list.
 */
