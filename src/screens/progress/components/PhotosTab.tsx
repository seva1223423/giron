      ...
      {!loadingPhotos && progressPhotos.length === 0 && (
        <FadeIn delay={120}>
          <View style={{ alignItems: 'center', paddingVertical: spacing.huge }}>
            <View style={{ width: 64, height: 64, borderRadius: 32, backgroundColor: colors.primary + '12', borderWidth: 1.5, borderColor: colors.primary + '40', alignItems: 'center', justifyContent: 'center' }}><Text style={{ fontSize: 24, fontWeight: '700', color: colors.primary }}>◧</Text></View>
