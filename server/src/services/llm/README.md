...
- YandexGPT Lite async: **~2 100 000 ₽/мес = ~$23k** — *дороже* при таком объёме, но на Y1 масштабах Iron Gym (<100k MAU) будет **в 3× дешевле** из-за async-скидки на малых объёмах.
